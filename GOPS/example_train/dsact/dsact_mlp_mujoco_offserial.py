...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", type=str, default="pyth_gazebo_parking", help="id of environment")
    ...
    parser.add_argument("--seed", default=None, help="Global seed")
    ################################################
    ...
    parser.add_argument("--policy_min_log_std", type=float, default=-6.0)
